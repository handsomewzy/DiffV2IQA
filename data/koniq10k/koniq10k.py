...
class Koniq10k_diff(torch.utils.data.Dataset):
    def __init__(self, dis_path, txt_file_name, list_name, transform, keep_ratio):
        super(Koniq10k_diff, self).__init__()
        self.dis_path = dis_path
        self.txt_file_name = txt_file_name
        self.transform = transform
    ...
    def __getitem__(self, idx):
        ...
        dir_path = '/mnt/workspace/workgroup/zhaoyang.wzy/koniq/diffusion_imgs_pipal' # 全部数据
